...
f = open(r'C:\Users\trga500\Desktop\Data\Collection\Week 6\GoNoGo\Results\WeeklyAnalysis_onlyCorrect.csv', 'wb+')
...
f4 = pyplot.savefig(r'Results\RT_OC.png')
f4 = pyplot.show()
...
f5 = pyplot.savefig(r'Results\ACC_OC.png')
f5 = pyplot.show()
...
f6 = pyplot.savefig(r'Results\EFF_OC.png')
f6 = pyplot.show()
